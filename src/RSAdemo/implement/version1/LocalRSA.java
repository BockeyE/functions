...
public class LocalRSA {
    ...
    public BigInteger[][] generateKey(BigInteger p, BigInteger q) {
...
//    }
    ...
    public static void main(String[] args) {
        ...
        LocalRSA rsa = new LocalRSA();
        // 生成公钥私钥'''
        // pubkey, selfkey = gen_key(p, q)
        BigInteger[][] keys = rsa.generateKey(p, q);
        ...
        BigInteger d = rsa.encrypt(c, selfkey);
        System.out.println("被解密后信息：" + d);

        long l3 = System.currentTimeMillis();

        System.out.println("en time" + (l2 - l1));
        System.out.println("de time" + (l3 - l2));
